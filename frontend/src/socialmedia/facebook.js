...
export function FacebookTracking() {
  ...
  return (
    <div className="p-2 md:p-6 bg-gray-50 min-h-screen text-gray-800 w-full max-w-full overflow-x-hidden">
      ...
      {selectedPages.length === 1 ? (
        /* ===== SINGLE ACCOUNT VIEW (unchanged 2-col grid) ===== */
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-4 md:mb-6">
          ...
          <TrendChart title="Likes Trend" data={chartData} dataKey="likesVal" color="#34d399" color2="#2dd4bf" icon={ThumbsUp} />
          <TrendChart title="Comments Trend" data={chartData} dataKey="commentsVal" color="#fbbf24" color2="#fb923c" icon={MessageCircle} />
          <TrendChart title="Shares Trend" data={chartData} dataKey="sharesVal" color="#818cf8" color2="#c084fc" icon={Share2} />
          <TrendChart title="Engagement Trend" data={chartData} dataKey="engagementVal" color="#facc15" color2="#fde047" icon={Zap} />
          <TrendChart title="Views Trend" data={chartData} dataKey="viewsVal" color="#ec4899" color2="#f472b6" icon={Eye} />
        </div>
      ) : (
        /* ===== ALL ACCOUNTS VIEW (new layout) ===== */
        <>
          ...
          {/* Row 2: Views + Likes (2 cols) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-4 md:mb-6">
            <TrendChart title="Views Trend" data={chartData} dataKey="viewsVal" color="#ec4899" color2="#f472b6" icon={Eye} />
            <TrendChart title="Likes Trend" data={chartData} dataKey="likesVal" color="#34d399" color2="#2dd4bf" icon={ThumbsUp} />
          </div>

          {/* Row 3: Comments + Shares (2 cols) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-4 md:mb-6">
            <TrendChart title="Comments Trend" data={chartData} dataKey="commentsVal" color="#fbbf24" color2="#fb923c" icon={MessageCircle} />
            <TrendChart title="Shares Trend" data={chartData} dataKey="sharesVal" color="#818cf8" color2="#c084fc" icon={Share2} />
          </div>
      ...
      <div className="flex justify-center mt-6 mb-10">
        <button
          onClick={() => fetchPosts((pagination?.page || 1) + 1)}
